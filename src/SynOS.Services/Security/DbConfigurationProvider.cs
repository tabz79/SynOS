        ...
        public override void Load()
        {
            ...
            try
            {
                ...
                if (profile != null)
                {
                    Data = new Dictionary<string, string?>(StringComparer.OrdinalIgnoreCase)
                    {
                        ...
                        { "Backup:EncryptionKey", string.IsNullOrWhiteSpace(profile.BackupEncryptionKey) ? "TBZ-BACKUP-KEY-12345-67890" : profile.BackupEncryptionKey },
            ...
            if (!loaded)
            {
                ...
                Data = new Dictionary<string, string?>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    { "Backup:EncryptionKey", "TBZ-BACKUP-KEY-12345-67890" },
